...
const TOOL_CATEGORIES = [
  ...
  { label: 'Documents & Forms', tools: ['list_document_templates', 'get_document_template', 'create_document_template', 'update_document_template', 'delete_document_template', 'duplicate_document_template', 'add_document_section', 'update_document_section', 'delete_document_section', 'reorder_document_sections', 'list_form_templates', 'get_form_template', 'create_form_template', 'update_form_template', 'delete_form_template', 'duplicate_form_template', 'add_form_field', 'update_form_field', 'delete_form_field', 'reorder_form_fields', 'send_form', 'list_form_submissions', 'get_form_submission', 'send_for_signing', 'list_signing_envelopes'] },
