...
export const COMPANY: ResourceGroup = {
  ...
  endpoints: [
    ...
    { method: 'GET', path: '/company/crm-settings', description: 'Get CRM settings including custom field definitions, lead sources, lost/won reasons, type option lists (opportunity, account, contact), transcript settings, feature toggles (accounts_enabled, contacts_enabled, enable_work_orders), form_completion_notify_emails, automation_error_notify_emails, and automation_error_notify_phones. All fields are stored in the company_settings table.', scopes: ['company:read'], isWrite: false },
