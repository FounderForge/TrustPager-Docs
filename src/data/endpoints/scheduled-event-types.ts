  ...
  "meta": { "credits_remaining": 9500 }
    ...
    },
    {
      ...
      params: [
        ...
        { name: 'is_bookable', type: 'boolean', required: false, description: 'If true, external bookers can book this type publicly', in: 'body' },
        ...
        { name: 'booking_pipeline_id', type: 'uuid', required: false, description: 'Pipeline for auto-created opportunities', in: 'body' },
        { name: 'booking_stage_id', type: 'uuid', required: false, description: 'Stage for auto-created opportunities', in: 'body' },
        { name: 'booking_auto_create_deal', type: 'boolean', required: false, description: 'Whether to auto-create a CRM opportunity when booked (default true). Param name preserved for backward compatibility.', in: 'body' },
        { name: 'booking_lead_source', type: 'string', required: false, description: 'Lead source for auto-created opportunities (default "booking")', in: 'body' },
        { name: 'booking_deal_name_template', type: 'string', required: false, description: 'Opportunity name template (param name preserved for backward compatibility). Variables: {event_type}, {customer_name}, {date}, {time}', in: 'body' },
        { name: 'booking_assigned_user_ids', type: 'array', required: false, description: 'Team member UUIDs to assign to opportunities and check calendar availability', in: 'body' },
        { name: 'booking_default_tags', type: 'array', required: false, description: 'Tags auto-applied to opportunities. Array of {name, color} objects.', in: 'body' },
        { name: 'booking_default_products', type: 'array', required: false, description: 'Products auto-attached to opportunities. Array of {id, quantity} objects.', in: 'body' },
        ...
        { name: 'booking_deal_behavior', type: 'string', required: false, description: 'How bookings interact with CRM opportunities (param name preserved for backward compatibility): "create" (always new), "update_or_create" (match existing or create), "never_create" (match only). Default: "create".', in: 'body' },
  ...
  "meta": { "credits_remaining": 9500 }
    ...
    },
    {
      ...
      params: [
        ...
        { name: 'is_bookable', type: 'boolean', required: false, description: 'Whether external bookers can book this type publicly', in: 'body' },
