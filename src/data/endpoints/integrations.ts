  ...
  endpoints: [
    ...
    },
    {
      ...
      params: [
        ...
        { name: 'params.deal_product_ids', type: 'uuid[]', required: false, description: 'For xero_create_repeating_invoice: array of crm_deal_products.id to include on the repeating invoice. Use when creating from the opportunity-page modal. Requires a deal ID to be present in the action data context. Mutually exclusive with product_ids.', in: 'body' },
        { name: 'params.approve_for_sending', type: 'boolean', required: false, description: 'For xero_create_repeating_invoice: whether Xero auto-emails the invoice to the contact on each billing cycle. Defaults to true. Set to false to suppress automatic emails (the invoice will still be created in Xero and marked as sent).', in: 'body' },
      ],
    },
  ],
};
