...
export const SIGNALS: ResourceGroup = {
  id: 'signals',
  label: 'Trust Signals',
  description: 'Public B2B trust profiles, verified reviews, and case studies. Build credibility with a public reputation page at trustpager.com/trust/<slug>. Includes a companion anonymous image upload endpoint for reviewer logos and avatars.',
  endpoints: [
    // ==================== IMAGE UPLOAD ====================
    {
      method: 'POST',
      path: 'https://ucqwijexmjctglmrxlej.supabase.co/functions/v1/public-image-upload',
      description: 'Anonymous public image upload endpoint. No API key required. Accepts PNG, WebP, JPEG, or SVG up to 100 KB. Stores in Cloudflare R2 at trustpager.net/uploads/<context>/<sha256>.<ext>. Rate limited to 3 uploads per IP or browser fingerprint per 24 hours. Use context=trust-review-logo for reviewer company logos and context=form-avatar for reviewer headshots.',
      scopes: [],
      isWrite: true,
      params: [
        ...
        { name: 'context', type: 'string', required: true, description: 'Upload namespace. Must be one of: trust-review-logo, form-avatar', in: 'body' },
  ...
  -F "context=trust-review-logo"`,
      responseExample: `{
  "url": "https://trustpager.net/uploads/trust-review-logo/a3f9c1d2e4b7890abc123def456789012345678901234567890abcdef12345678.png"
}`,
    },
    // ==================== PROFILE ====================
    {
      method: 'GET',
      path: '/signals/profile',
      description: 'Get the company\'s public Trust Signals profile (singleton per company). Returns slug, display name, category, branding, overall rating, review/case-study counts, publish state, and settings.',
      scopes: ['signals:read'],
      isWrite: false,
      params: [],
      requestExample: `curl https://ucqwijexmjctglmrxlej.supabase.co/functions/v1/api/v1/signals/profile \\
  ...
  "meta": { "credits_remaining": 4500 }
    ...
    },
    {
      method: 'POST',
      path: '/signals/profile',
      description: 'Create or update the company\'s Trust Signals profile (upsert). On creation, slug and display_name are required. On update, only the provided fields are changed.',
      ...
      params: [
        ...
        { name: 'category_id', type: 'string', required: false, description: 'Trust category UUID.', in: 'body' },
        ...
        { name: 'is_published', type: 'boolean', required: false, description: 'true = live at trustpager.com/trust/<slug>.', in: 'body' },
      ],
      requestExample: `curl -X POST https://ucqwijexmjctglmrxlej.supabase.co/functions/v1/api/v1/signals/profile \\
  -H "Authorization: Bearer tp_live_..." \\
  ...
  "meta": { "credits_remaining": 4499, "url": "https://app.trustpager.com/tools/trust-signals/profile" }
}`,
    },
    {
      method: 'GET',
      path: '/signals/stats',
      description: 'Get aggregate stats for the company\'s Trust Signals: profile state, total/published review count, rating distribution (1-5), and case study counts by status.',
      scopes: ['signals:read'],
      isWrite: false,
      params: [],
      requestExample: `curl https://ucqwijexmjctglmrxlej.supabase.co/functions/v1/api/v1/signals/stats \\
  -H "Authorization: Bearer tp_live_..."`,
      responseExample: `{
  "data": {
    "has_profile": true,
  ...
  "meta": { "credits_remaining": 4498 }
    ...
    // ==================== REVIEWS ====================
    {
      ...
      description: 'List reviews on the company\'s Trust Signals profile. Supports cursor pagination. Filter by status, featured, service_category, or rating. Use search for fuzzy match on reviewer name or testimonial.',
      scopes: ['signals:read'],
      isWrite: false,
      params: [
      ...
      requestExample: `curl https://ucqwijexmjctglmrxlej.supabase.co/functions/v1/api/v1/signals/reviews?status=published \\
  -H "Authorization: Bearer tp_live_..."`,
      responseExample: `{
  "data": [
    {
      ...
      "reviewer_company_logo": "https://trustpager.net/uploads/trust-review-logo/abc123.png",
      "reviewer_role": "CMO",
  ...
  "meta": {
    ...
    },
    {
      method: 'POST',
      path: '/signals/reviews',
      description: 'Create a new trust review (starts in "draft" status). Required fields: profile_id, reviewer_name, rating (1-5), testimonial_text. Supply reviewer_company_logo and reviewer_avatar as URLs from the public-image-upload endpoint for richer display.',
      scopes: ['signals:write'],
      isWrite: true,
      params: [
        { name: 'profile_id', type: 'string', required: true, description: 'Trust profile UUID', in: 'body' },
        ...
        { name: 'reviewer_company_logo', type: 'string', required: false, description: 'URL of reviewer company logo. Use public-image-upload (context: trust-review-logo).', in: 'body' },
      ...
      requestExample: `curl -X POST https://ucqwijexmjctglmrxlej.supabase.co/functions/v1/api/v1/signals/reviews \\
  -H "Authorization: Bearer tp_live_..." \\
  -H "Content-Type: application/json" \\
  -d '{
    "profile_id": "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
  ...
  "meta": { "credits_remaining": 4498, "url": "https://app.trustpager.com/tools/trust-signals/reviews" }
}`,
    },
    {
      method: 'PATCH',
      path: '/signals/reviews/:id',
      description: 'Update a trust review. Accepts all writable fields. Setting vendor_response auto-stamps vendor_response_by and vendor_response_at. Use reviewer_company_logo and reviewer_avatar to attach images uploaded via public-image-upload.',
      scopes: ['signals:write'],
      isWrite: true,
      params: [
      ...
      requestExample: `curl -X PATCH https://ucqwijexmjctglmrxlej.supabase.co/functions/v1/api/v1/signals/reviews/e14dad66-b422-42d4-a636-cd17af1c9970 \\
  -H "Authorization: Bearer tp_live_..." \\
  -H "Content-Type: application/json" \\
  -d '{
    "reviewer_company_logo": "https://trustpager.net/uploads/trust-review-logo/abc123.png",
  ...
  "meta": { "credits_remaining": 4497 }
    ...
    {
      method: 'POST',
      path: '/signals/reviews/:id/approve',
      ...
      requestExample: `curl -X POST https://ucqwijexmjctglmrxlej.supabase.co/functions/v1/api/v1/signals/reviews/e14dad66-b422-42d4-a636-cd17af1c9970/approve \\
  -H "Authorization: Bearer tp_live_..."`,
      responseExample: `{
  ...
  "meta": { "credits_remaining": 4496 }
    ...
    {
      method: 'POST',
      path: '/signals/reviews/:id/publish',
      ...
      requestExample: `curl -X POST https://ucqwijexmjctglmrxlej.supabase.co/functions/v1/api/v1/signals/reviews/e14dad66-b422-42d4-a636-cd17af1c9970/publish \\
  -H "Authorization: Bearer tp_live_..."`,
      responseExample: `{
  ...
  "meta": { "credits_remaining": 4495 }
    ...
    },
    {
      ...
      scopes: ['signals:delete'],
      isWrite: true,
      params: [
        { name: 'id', type: 'string', required: true, description: 'Review UUID', in: 'path' },
      ],
      requestExample: `curl -X DELETE https://ucqwijexmjctglmrxlej.supabase.co/functions/v1/api/v1/signals/reviews/e14dad66-b422-42d4-a636-cd17af1c9970 \\
  -H "Authorization: Bearer tp_live_..."`,
