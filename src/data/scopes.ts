...
export const SCOPE_GROUPS: ScopeGroup[] = [
  ...
  },
  {
    ...
    scopes: [
      ...
      { key: 'schedules:delete', label: 'Event Schedules (Delete)' },
      { key: 'webhooks:read', label: 'Webhooks (Read)' },
      { key: 'webhooks:write', label: 'Webhooks (Write)' },
      { key: 'ai:use', label: 'AI Features' },
      { key: 'agent-ops:read', label: 'Agent Operations (Read)' },
      { key: 'agent-ops:write', label: 'Agent Operations (Write)' },
      { key: 'agent-ops:delete', label: 'Agent Operations (Delete)' },
